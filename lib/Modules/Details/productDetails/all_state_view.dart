...
class AllStateView extends StatefulWidget {
  const AllStateView({Key? key}) : super(key: key);

  @override
  State<AllStateView> createState() => _AllStateViewState();
}

class _AllStateViewState extends State<AllStateView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("جميع الفئات",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),) ,
          leading: IconButton(icon: Icon(Icons.close,color: Colors.black,size: 25,),onPressed: (){Navigator.pop(context);},),
        ),
